...
export default function blog10() {
  return (
    <HeroLayout>
      ...
      <div className="blog10-header">
        <div className="blog10-header-content">
          <h1 className="page-title">Blog</h1>
        </div>
      </div>

      <div className="blog10-inner-page">

        <div className="blog10-author">
        ...
        <div className="blog10-inner-header">
          <h1>
            Jellybean Casino Review: An Exceptional Online Gaming Experience
          </h1>
        </div>

        <div className="blog10-inner-content">
          <p>
