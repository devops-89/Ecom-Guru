...
export default function Blog8() {
  return (
    <HeroLayout>
      ...
      <div className="blog8-header">
        <div className="blog8-header-content">
          <h1 className="page-title">Blog</h1>
        </div>
      </div>

      <div className="blog8-inner-page">

        <div className="blog8-author">
        ...
        <div className="blog8-inner-header">
          <h1>
            Jellybean Casino Review: An Exceptional Online Gaming Experience
          </h1>
        </div>

        <div className="blog8-inner-content">
          <p>
