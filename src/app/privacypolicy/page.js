...
export default function PrivacyPolicy() {
    ...
    <>
      ...
      <section className="privacyTop-header">
        <div className="privacyTop-header-content">
          <h1 className="page-title">PrivacyPolicy</h1>
          <p className="page-subtitle">The eComguru protects what we are trusted with.</p>
        </div>
      </section>
        <section className="privacyTop">
            <p>
            We care about data privacy and security. By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Use. Please be advised the Site is hosted in the India.
            </p>
            <p>
            ...
            A copy of your Notification will be sent to the person who posted or stored the material addressed in the Notification. Please be advised that pursuant to federal law you may be held liable for damages if you make material misrepresentations in a Notification. Thus, if you are not sure that material located on or linked to by the Site infringes your copyright, you should consider first contacting an attorney.
                ...
                <ol>
                    ...
                    <li>a statement that you consent to the jurisdiction of the court in which your address is located, or if your address is outside the India, for any judicial district in which we are located;</li>
                    ...
                    <li>
your physical or electronic signature.</li>
                </ol>
            <p>
