  ...
  return (
    <HeroLayout>
      ...
      <div className="blog7-header">
        <div className="blog7-header-content">
          <h1 className="page-title">Blog</h1>
        </div>
      </div>

      <div className="blog7-inner-page">

        <div className="blog7-author">
        ...
        <div className="blog7-inner-header">
          <h1>
            Jellybean Casino Review: An Exceptional Online Gaming Experience
          </h1>
        </div>

        <div className="blog7-inner-content">
          <p>
